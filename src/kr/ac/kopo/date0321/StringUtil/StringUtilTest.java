...
public class StringUtilTest {
	...
	public static void removeCharMethodTest() {
	...
	public static void checkCharMethodTest() {
	...
	public static void maxMethodTest() {
		int num1 = (int) (Math.random() * 100);
		int num2 = (int) (Math.random() * 100);
	...
	public static void isLowercharMethodTest() {
	...
	public static void isUpperCharMethodTest() {
